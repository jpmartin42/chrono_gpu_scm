...
int main(int argc, char* argv[]) {
    ...
    pendulumBody->SetPos(ChVector3<>(0, 3, 0));
    pendulumBody->SetPosDt(ChVector3<>(1, 0, 0));
    ...
    ChFrame<> link_position_abs(ChVector3<>(0, 4, 0));
    ...
    vis.AddCamera(ChVector3<>(2, 2, -5), ChVector3<>(0, 1, 0));
